...
$string['nametopcoll'] = 'Stunning view course';
$string['formattopcoll'] = 'Stunning view course';
...
$string['pluginname'] = 'Stunning view course';
...
$string['setextraelements_help'] = 'Indicate if you want to show a Profile user and a Notice board with the las post in it.';
...
// Capabilities.
$string['stunning:changelayout'] = 'Change or reset the layout';
$string['stunning:changecolour'] = 'Change or reset the colour';
$string['stunning:changetogglealignment'] = 'Change or reset the toggle alignment';
$string['stunning:changetoggleiconset'] = 'Change or reset the toggle icon set';
...
$string['setextraelements'] = 'Set Extra Elements';
$string['extraelements'] = 'Extra Elements';
$string['extraelements_detail'] = 'Elements to show like notice board and profile block';
$string['setnotice'] = 'Show Notice board';
$string['setprofile'] = 'Show Profile block';
$string['setnotice_profile'] = 'Show Profile block and Notice board';
$string['set_noelements'] = 'No Add extra elements';
$string['order'] = 'Order';
$string['order_help'] = 'Indicate el order of appearecen of an element the lower the value the more early it will appear';
$string['delete'] = 'Delete?';
$string['delete_help'] = 'If this is active the link will be remove';
$string['norecords'] = 'There is no records for this course';
$string['imageurl'] = 'Image URL';
$string['imageurl_help'] = 'The url direction of the image. The image need to be at max 45 x 45 px ';
$string['banner'] = 'The banner URL';
$string['banner_help'] = 'The url direction of the image. The image need to be at max 45 x 45 px ';
$string['type'] = 'Type';
$string['type_help'] = 'The Banner Type it must be a image or a SWF';
$string['activity'] = 'Activity';
$string['activity_help'] = 'The activity to link with the image, set other to add a custom url';
$string['url'] = 'URl';
$string['url_help'] = 'Is to add a custom URL to link with the image. It can only be active is activity is set to other.';
$string['addlink'] = 'Add Link';
$string['addicon'] = 'Add Icon';
$string['reorder'] = 'Reorder';
$string['image'] = 'Image';
$string['wanttodelete'] = 'wanttodelete';
